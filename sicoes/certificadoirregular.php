...
$mat10=$_SESSION['materia10'];
$mat11=$_SESSION['materia11'];
$mat12=$_SESSION['materia12'];
$mat13=$_SESSION['materia13'];
$mat14=$_SESSION['materia14'];
...
$pdf->Ln(5);
$pdf->Cell(40);
$pdf->Cell(90,30,"CLAVE"."              "."NOMBRE                                     FIRMA");
...
$pdf->Ln(0);
$pdf->Cell(120);
$pdf->Cell(90,30,"______________________");
}
if ($mat2 <> "" )
{
...
if ($mat9 <> "" )
{
//$consulta8="select Nombre,Cred from sicoesnvo.Materias where MATERIA='$mat9';";
//$consulta7="select Nombre,Cred from Materias where MATERIA='$mat9';";
...
$cred8=$arreglo8["Cred"];//selecciona los grupos del alumno
$pdf->SetFont('Arial','B',8);
$pdf->Ln(5);
$pdf->Cell(40);
...
$cred9=$arreglo9["Cred"];//selecciona los grupos del alumno
$pdf->SetFont('Arial','B',8);
$pdf->Ln(5);
$pdf->Cell(40);
$pdf->Cell(90,30,$mat10."   ".$nom9);
$pdf->Ln(0);
$pdf->Cell(120);
$pdf->Cell(90,30,"______________________");
}
...
$nom10=$arreglo10['Nombre'];
$cred10=$arreglo10["Cred"];//selecciona los grupos del alumno
$pdf->SetFont('Arial','B',8);
$pdf->Ln(5);
$pdf->Cell(40);
$pdf->Cell(90,30,$mat11."   ".$nom10);
$pdf->Ln(0);
$pdf->Cell(120);
$pdf->Cell(90,30,"______________________");
}
...
//$consulta8="select Nombre,Cred from sicoesnvo.Materias where MATERIA='$mat9';";
//$consulta7="select Nombre,Cred from Materias where MATERIA='$mat9';";
$resasig11=$sicoesnvo->query("select Nombre,Cred from Materias where MATERIA='$mat12'");
$arreglo11= $resasig11->fetch_array(MYSQLI_ASSOC);
$nom11=$arreglo11['Nombre'];
$cred11=$arreglo11["Cred"];//selecciona los grupos del alumno
$pdf->SetFont('Arial','B',8);
$pdf->Ln(5);
$pdf->Cell(40);
$pdf->Cell(90,30,$mat12."   ".$nom11);
$pdf->Ln(0);
$pdf->Cell(120);
$pdf->Cell(90,30,"______________________");
}
