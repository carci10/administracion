...
<fieldset style="border-style: solid"> <legend align="left"><strong><h1>Menu Alumnos Posgrado</h1></strong></legend>
...
<select name="periodo" id="periodo"  required>
  <?php
  	//include('config.php');
	$periodo	= "SELECT * FROM periodos where estado_perido=1";
