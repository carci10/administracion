...
function eliminar(id){
	...
	if(confirm(mensaje)){
		window.location="eliminarcita.php?Id="+id;
	}else{
...
<center>
<small><font color="red">* !!Cuidadado, al eleminar las citas el aspirante no puede visualizarlas en su sesion!! 
</font></small>
</center>
<table width="100%">
		<tr>
		<td class="down1">
		<strong><center>
		 CONSULTA DE CITAS DE ASPIRANTES
		</center></strong>
		</td>
		</tr>
...
<table id="table" cellspacing="0" width="100%">
 ...
 include('conexion.php');
 $contador = 0;
 $sql = "select citas.id_fecha,citas.id_aspirante,fecha_cita.fecha,fecha_cita.hora from citas,fecha_cita where citas.id_fecha=fecha_cita.id_fecha;";
