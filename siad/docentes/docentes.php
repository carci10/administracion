            ...
            $codigo = $_SESSION["Codigo"];
              ...
              $consulta=mysqli_query($conexion,"select Foto from usuarios where Codigo = '$codigo'");                  
                while($filas=mysqli_fetch_array($consulta)){
                 ...
                 $consulta2 = mysqli_query($conexion,"select concat (nombre_maestro, ' ', apellido_p,' ',apellido_m) as Docente from profesores where id_profesor = $codigo"); 
 ...
 ?>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="../../al/login.php" class="btn btn-primary"> <i class="glyphicon glyphicon-download"></i>   Entrar</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Evaluaciones Extraordinarias</h4>
