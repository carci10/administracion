<div class="col-md-3">
     ...
     <a href="#" class="list-group-item"> <i class="glyphicon glyphicon-folder-open"></i>   &nbsp;&nbsp; Material Didactico
                    </a>
        <a href="#" class="list-group-item"><i class="glyphicon glyphicon-file"></i>   &nbsp;&nbsp; Planificacion de Tareas
                    </a>
            <a href="evaluacion_estudiantes.php" class="list-group-item"> <i class="glyphicon glyphicon-pencil"></i>   &nbsp;&nbsp; Evaluacion Extraordinaria
                    </a>
    <a href="../../al/login.php" class="list-group-item"> <i class="glyphicon glyphicon-edit"></i>   &nbsp;&nbsp; Evaluacion Ordinaria
                    </a>
