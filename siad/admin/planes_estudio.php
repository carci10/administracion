     ...
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
          ...
          $carrera=mysqli_query($conexion,$consulta1);
           $consulta4="select id_materia, nombre_materia from materias";
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <div class="row">
		               ...
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir la descripcion o el nombre del Plan de Estudios">
		               </div>
		               	<div class="col-md-6">
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM planes"));
          ...
          <div class="modal-content">
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Plan:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="nombre" name="nombre" required maxlength="50" onkeyup="javascript:this.value=this.value.toUpperCase();"></div>
			   </div> <br>    
				
				<div class="form-group"> <label for="carnet" class="col-md-2 control-label">Creditos:</label>
				<div class="col-md-10"><input type="number" class="form-control" id="creditos" name="creditos" required maxlength="10"></div>
			   </div> <br>    
				
				<div class="form-group"> <label for="year" class="col-md-2 control-label">Año:</label>
                         <div class="col-md-10">
                       <input type="number" class="form-control" id="año" name="ano" required maxlength="50">
                       </div>
                    </div> <br>
