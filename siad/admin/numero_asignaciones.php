...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Tipos de Evaluaciones </b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               ...
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Numero de Asignacion">
		               	...
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo tipo de Evaluacion</button>
		               </div>
	              <br>
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM tipos_evaluaciones"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-sort-by-order'></i>&nbsp;&nbsp;Tipos de Evaluaciones</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Evaluacion:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="evaluacion" name="evaluacion" required maxlength="50" onkeyup="javascript:this.value=this.value.toUpperCase();"></div>
			   </div> <br>    
                     <br>
