        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
				...
				<div class="form-group"> <label for="nombre" class="col-md-2 control-label">Clave Docente :</label>
				<div class="col-md-10"><input type="int" class="form-control" id="clave" name="clave" required maxlength="10"></div>
			   </div><br><br>
			   ...
			   <div class="form-group"> <label for="apellido" class="col-md-2 control-label">Apellido Paterno:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="apellido_p" name="apellido_p" required maxlength="50"></div>
			   </div><br><br>
				<div class="form-group"> <label for="apellido" class="col-md-2 control-label">Apellido Materno:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="apellido_m" name="apellido_m" required maxlength="50"></div>
			   </div><br><br>
			   
			
				<div class="form-group"> <label for="apellido" class="col-md-2 control-label">Fecha Nacimiento:</label>
				<div class="col-md-5"><input type="date" class="form-control" id="fecha_nac" name="fecha_nac" required></div>
			   </div><br><br>
			   ...
			   <div class="form-group"> <label for="celular" class="col-md-2 control-label">Grado:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="grado" name="grado" required maxlength="8"></div>
			   </div><br><br>
			   <div class="form-group"> <label for="telefono" class="col-md-2 control-label">Carrera:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="carrera" name="carrera" required maxlength="40"></div>
			   </div><br>
