...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
           <?php 
          $consulta1="select id_profesor, concat(nombre_maestro, ' ' ,apellido_p,'',apellido_m) as Docentes FROM profesores";
          ...
          $consulta4="select id_periodo, descripcion_periodo from periodos where estado_perido=1";
          $periodo=mysqli_query($conexion,$consulta4);
          $consulta5="select id_tipoi,descripcion from tipo_inscripcion";
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Asignaciones Docentes</b></h4></center>
        </div>
...
include('conexion.php');
    ...
    echo "Total asignaciones: $numeroRegistros .- Correspondientes al periodo: $periodo_actual";
        ?>
        </h4>
          </center>
      </div>
				...
				<div class="col-md-10"><input type="text" class="form-control" required readonly id="pro" name="pro" hidden="true" /></div>
                    ...
                    <div class="form-group"> <label for="year" class="col-md-2 control-label">Grupo:</label>
                     ...
                     <?php 
                        ...
                        <div class="form-group"> <label for="year" class="col-md-2 control-label">Periodo:</label>
                         <div class="col-md-10">
                     ...
                     <div class="form-group"> <label for="year" class="col-md-2 control-label">Tipo Asigancion:</label>
                         <div class="col-md-10">
