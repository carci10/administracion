...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$estudiantes = mysqli_query($conexion,"SELECT * FROM alumnos");
$item = 0;
while($estudiantes2 = mysqli_fetch_array($estudiantes)){
	$item = $item+1;
	$pdf->Cell(10, 8, $item, 0);
	$pdf->Cell(20, 8, $estudiantes2['matricula'], 0);
	$pdf->Cell(30, 8, utf8_decode($estudiantes2['nombre_alumno']), 0);
	$pdf->Cell(30, 8, utf8_decode($estudiantes2['apellido_p']), 0);
	$pdf->Cell(30, 8, $estudiantes2['apellido_m'], 0);
    $pdf->Cell(50, 8, $estudiantes2['correo'], 0);
   	$pdf->Cell(20, 8, $estudiantes2['telefono_movil'], 0);
	$pdf->Ln(5);
}
$pdf->Ln(8);
