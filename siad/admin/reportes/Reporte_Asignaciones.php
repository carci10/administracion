...
where imparte.id_periodo=periodos.id_periodo and periodos.estado_perido=1
        ...
        $item = 0;
			while($asignaciones2 = mysqli_fetch_array($asignaciones)){
				...
				$pdf->Cell(8, 8, utf8_decode($asignaciones2['id']), 0,'C');
				$pdf->Cell(10, 8, $asignaciones2['Asignacion'], 0, 'C');
				$pdf->Cell(45, 8, utf8_decode($asignaciones2['Docente']), 0,'C');
				$pdf->Cell(73, 8, utf8_decode($asignaciones2['Asignatura']), 0,'C');
