...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
		  ...
		  $consulta2="select id_plan, descripcion_plan from planes";
          $plan=mysqli_query($conexion,$consulta2);
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Especialidades</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el nombre de la especialidad">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nueva Espacialidad</button> 
		               </div>
	              <br>
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM especialidad"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-calendar'></i>&nbsp;&nbsp;Especialidad</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
				...
				<div class="form-group"> <label for="tipo" class="col-md-2 control-label">Carrera:</label>
                         <div class="col-md-10">
				...
				<div class="form-group"> <label for="tipo" class="col-md-2 control-label">Plan de Estudio:</label>
                         <div class="col-md-10">
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Nombre Especialidad:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="nombre_especialidad" name="nombre_especialidad" required maxlength="50"></div>
			   </div> <br>
                 <div id="mensaje"></div>           
             </div>         
