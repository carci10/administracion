...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
		  ...
		  $consulta1="select * from  tipos_evaluaciones";
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>ADMIN DE PERIODOS </b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Periodo">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Periodo Escolar</button> 
		               </div>
	              <br>
 <br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-time'></i>&nbsp;&nbsp;Periodos</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Nombre Periodo:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="periodo" name="periodo" required maxlength="15"></div>
			   </div> <br><br>
				
				<div class="form-group"> <label for="plan" class="col-md-2 control-label">Evaluacion:</label>
                         <div class="col-md-10">
                       <select class="form-control" id="evaluacion" name="evaluacion">
                     <?php 
                          while($fila=mysqli_fetch_row($evaluacion)){
