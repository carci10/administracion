          ...
          <div class="modal-content">
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Carrera:</label>
				...
				<div class="form-group"> <label for="carnet" class="col-md-2 control-label">Clave Carrera:</label>
				<div class="col-md-10"><input type="text" onchange="javascript:this.value=this.value.toUpperCase();" class="form-control" id="clave_c" name="clave_c" required ></div>
			   </div> <br>
