...
<?php include('includes/menuPublico.php') ?>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('imagenes/f1s.jpg');"></div>
                <div class="carousel-caption">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                     Sistema de Control Escolar TES Ixtapaluca (SiCoEs)
                </h1>
            </div>
            <div class="col-lg-12">
                <p>
                     Bienvenidos al Si-Co-Es TESI
                <p>
                <br>
            </div>
             <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4>Administrador</h4>
                        <p>Esta seccion es solo para el administrador del SiCoEs, este es el encargado de administrar y supervisar todas las actividades de todos los usuarios (estudiantes y docentes) y lo relacionado con la parte academica.</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Que puedes hacer con el SiCoEs</h2>
            </div>
            <div class="col-md-6">
                <p>Con el sistema informatico de administracion docente, puedes realizar todas las actividades necesarias que faciliten el manejo del area academica del Tecnologico de Ixtapaluca, entre algunas de las actividades tenemos:</p>
                <ul>
