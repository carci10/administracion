...
//------------------------------------------------------	
	...
	$pdf->Image("../imagenes/historial.png",5,5,200);
	...
	//$pdf->Image("../imagenes/logo_tesi2.png", 185,8,20);
	$pdf->Ln(3);
	$pdf->SetFont("Arial", "B", 11);
	$pdf->Cell(190,5,utf8_decode("HISTORIAL ACADEMICO"),0,1,"C");
	...
	//IMPRIME QR
	$contenido = "Historial Academico emitido por el Tecnologico de Estudios Superiores de Ixtapaluca Alumno(a): $nombre $apellido_p $apellido_m, Creditos Cubiertos :$porcentaje_avance % Promedio General: $promedio  SIAD-TESI-JCCR "; //Texto
	...
	//IMprimir cadena Original de la consulta
	$pdf->SetXY(7,265);
	$pdf->SetFont("Arial","B",5);
