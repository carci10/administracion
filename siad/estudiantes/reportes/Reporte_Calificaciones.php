...
where matricula='$codigo'order by kardex.periodo_def" );



$consulta_promedio=mysqli_query($conexion, "select matricula, round(avg (definitiva),1) as promedio from kardex where matricula='$codigo'");
...
$pdf->Cell(0.1, 50, utf8_decode("                                                                                                                Promedio general de aprovechamiento: $promedio"), 0,'R');
